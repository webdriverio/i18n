...
> wdio-robonut-service jest pakietem zewnętrznym, więcej informacji na [GitHub](https://github.com/udarrr/wdio-robonut-service) | [npm](https://www.npmjs.com/package/wdio-robonut-service)
...
wdio-robonut-service to wieloplatformowa usługa (windows, darwin, linux) zapewniająca dostęp do myszy systemowej, klawiatury, schowka, ekranu oraz wyszukiwania szablonów obrazów na widocznym ekranie przy użyciu [nutjs](https://nutjs.dev/). Usługa umożliwia wykonywanie systemowych ruchów, kliknięć, kopiowania, wklejania, pisania i tym podobnych. Możliwe jest sprawdzanie istnienia i uzyskiwanie współrzędnych szablonu obrazu, przeciąganie i upuszczanie go i tak dalej.

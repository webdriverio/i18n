...
Tệp cấu hình chứa tất cả thông tin cần thiết để chạy bộ kiểm thử của bạn. Đây là một module NodeJS xuất ra một JSON.

Dưới đây là một ví dụ cấu hình với tất cả các thuộc tính được hỗ trợ và thông tin bổ sung:
...
Bạn cũng có thể tìm thấy một tệp với tất cả các tùy chọn và biến thể có thể có trong [thư mục ví dụ](https://github.com/webdriverio/webdriverio/blob/main/examples/wdio.conf.js).
...
Bạn cũng có thể tìm thấy một tệp với tất cả các tùy chọn và biến thể có thể trong [thư mục ví dụ](https://github.com/webdriverio/webdriverio/blob/main/examples/wdio.conf.js).
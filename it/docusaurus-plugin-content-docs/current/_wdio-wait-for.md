...
Se stai utilizzando WebdriverIO v7 e versioni precedenti con [CommonJS](https://en.wikipedia.org/wiki/CommonJS) devi usare `require` per importare il pacchetto, ad esempio:

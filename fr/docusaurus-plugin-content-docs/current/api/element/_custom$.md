...
Le `custom$` vous permet d'utiliser une stratégie personnalisée déclarée en utilisant `browser.addLocatorStrategy`.
Pour en savoir plus sur les stratégies de sélection personnalisées, consultez la [documentation des sélecteurs](../../selectors#custom-selector-strategies).

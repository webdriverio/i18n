...
Récupérer un [cookie](https://w3c.github.io/webdriver/webdriver-spec.html#cookies)
visible sur la page actuelle. Vous pouvez interroger un cookie spécifique en fournissant le nom du cookie ou
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>un objet qui permet de filtrer les cookies avec des attributs spécifiques</td>
    </tr>
  </tbody>
</table>
...
- **&lt;Cookie[]&gt;**
            **<code><var>return</var></code>:**                            cookies demandés
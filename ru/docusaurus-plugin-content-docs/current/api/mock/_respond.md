...
Всегда отвечать с одинаковой подменой.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>`MockOverwrite`</td>
      <td>полезная нагрузка для подмены ответа</td>
    </tr>
    <tr>
      <td><code><var>params</var></code><br /><span className="label labelWarning">optional</span></td>
      <td>`MockResponseParams`</td>
      <td>дополнительные параметры ответа для подмены</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>`Boolean`</td>
      <td>получить реальный ответ перед ответом с подмененными данными</td>
    </tr>
  </tbody>
</table>

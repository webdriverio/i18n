...
> wdio-robonut-service - это сторонний пакет, для получения дополнительной информации посетите [GitHub](https://github.com/udarrr/wdio-robonut-service) | [npm](https://www.npmjs.com/package/wdio-robonut-service)
...
wdio-robonut-service - это кроссплатформенный (windows, darwin, linux) сервис с доступом к системной мыши, клавиатуре, буферу обмена, экрану и поиску шаблонов изображений на видимом экране с использованием [nutjs](https://nutjs.dev/). С помощью сервиса можно выполнять системные перемещения, клики, копирование, вставку, ввод текста и так далее. Также возможно проверить существование и получить координаты шаблона изображения, перетаскивать его и так далее.

...
`custom$` आपको `browser.addLocatorStrategy` का उपयोग करके घोषित की गई कस्टम रणनीति का उपयोग करने की अनुमति देता है।
कस्टम सेलेक्टर रणनीतियों के बारे में [सेलेक्टर डॉक्स](../../selectors#custom-selector-strategies) में अधिक पढ़ें।

...
> wdio-zafira-listener-serviceはサードパーティのパッケージです。詳細については[GitHub](https://github.com/shashidharus/wdio-zafira-listener-service) | [npm](https://www.npmjs.com/package/wdio-zafira-listener-service)をご覧ください
テストを[Zafira Dashboard](http://demo.qaprosoft.com/zafira/)に報告するためのWDIO用カスタムサービス

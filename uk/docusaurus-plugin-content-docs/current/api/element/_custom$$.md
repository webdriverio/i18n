...
Метод `customs$$` дозволяє використовувати користувацьку стратегію вибору елементів, оголошену за допомогою `browser.addLocatorStrategy`.
Дізнайтеся більше про користувацькі стратегії вибору в [документації по селекторам](../../selectors#custom-selector-strategies).

...
> @sap_oss/wdio-qmate-service є пакетом третьої сторони, для додаткової інформації дивіться [GitHub](https://github.com/SAP/wdio-qmate-service) | [npm](https://www.npmjs.com/package/@sap_oss/wdio-qmate-service)
...
Сервіс Qmate - це спеціальний сервіс WebdriverIO, розроблений на TypeScript для тестування веб-додатків та API.

## Pages
Будь ласка, ознайомтеся з нашою офіційною та більш детальною документацією [тут](https://sap.github.io/wdio-qmate-service/).

## Installation
Щоб встановити останню версію сервісу, просто виконайте наступну команду:
```bash

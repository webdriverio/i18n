...
> @sap_oss/wdio-qmate-service é um pacote de terceiros, para mais informações consulte [GitHub](https://github.com/SAP/wdio-qmate-service) | [npm](https://www.npmjs.com/package/@sap_oss/wdio-qmate-service)
...
Qmate Service é um serviço personalizado WebdriverIO construído em TypeScript para testar aplicações web e APIs.

## Pages
Por favor, encontre nossa documentação oficial e mais detalhada [aqui](https://sap.github.io/wdio-qmate-service/).

## Installation
Para instalar a versão mais recente do serviço, simplesmente execute o seguinte comando:
```bash

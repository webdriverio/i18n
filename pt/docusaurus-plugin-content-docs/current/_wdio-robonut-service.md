...
> wdio-robonut-service é um pacote de terceiros, para mais informações, consulte [GitHub](https://github.com/udarrr/wdio-robonut-service) | [npm](https://www.npmjs.com/package/wdio-robonut-service)
...
wdio-robonut-service é um serviço multiplataforma (windows, darwin, linux) com acesso ao mouse do sistema, teclado, área de transferência, tela e busca de modelos de imagem na tela visível com [nutjs](https://nutjs.dev/) sob o capô. Com o serviço é possível realizar movimentos do sistema, cliques, copiar, colar, digitar e assim por diante. É possível verificar a existência e obter coordenadas de modelos de imagem, arrastar e soltar e assim por diante.

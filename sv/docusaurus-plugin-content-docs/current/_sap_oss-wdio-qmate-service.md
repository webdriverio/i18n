...
> @sap_oss/wdio-qmate-service är ett tredjepartspaket, för mer information se [GitHub](https://github.com/SAP/wdio-qmate-service) | [npm](https://www.npmjs.com/package/@sap_oss/wdio-qmate-service)
...
Qmate Service är en anpassad WebdriverIO-tjänst byggd i TypeScript för testning av webbapplikationer och API:er.

## Pages
Vår officiella och mer detaljerade dokumentation finns [här](https://sap.github.io/wdio-qmate-service/).

## Installation
För att installera den senaste versionen av tjänsten, kör helt enkelt följande kommando:
```bash

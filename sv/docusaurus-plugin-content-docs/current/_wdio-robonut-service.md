...
> wdio-robonut-service är ett tredjepartspaket, för mer information se [GitHub](https://github.com/udarrr/wdio-robonut-service) | [npm](https://www.npmjs.com/package/wdio-robonut-service)
...
wdio-robonut-service är en plattformsoberoende (windows, darwin, linux) tjänst med tillgång till systemets mus, tangentbord, urklipp, skärm och sökning efter bildmallar på synlig skärm med [nutjs](https://nutjs.dev/) under huven. Med tjänsten är det möjligt att utföra systemförflyttning, klicka, kopiera, klistra in, skriva och så vidare. Det är möjligt att kontrollera existensen och erhålla koordinater för bildmallar, dra och släppa dem och så vidare.

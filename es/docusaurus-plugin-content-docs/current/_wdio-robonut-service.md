...
wdio-robonut-service es un servicio multiplataforma (windows, darwin, linux) con acceso al ratón del sistema, teclado, portapapeles, pantalla y búsqueda de plantillas de imágenes en la pantalla visible con [nutjs](https://nutjs.dev/) bajo el capó. Con el servicio es posible realizar movimientos del sistema, clics, copiar, pegar, escribir y más. Es posible verificar la existencia y obtener coordenadas de plantillas de imágenes, arrastrar y soltar y más.

...
El `customs$$` te permite usar una estrategia personalizada declarada mediante `browser.addLocatorStrategy`.
Lee más sobre estrategias de selectores personalizadas en la [documentación de Selectores](../../selectors#custom-selector-strategies).

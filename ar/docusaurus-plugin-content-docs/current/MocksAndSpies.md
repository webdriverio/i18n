---
id: mocksandspies
title: محاكاة الطلبات والمراقبين
---
...
إذا كنت بحاجة إلى الانتظار حتى تتم الاستجابة لطلب مطابق، استخدم `mock.waitForResponse(options)`. راجع مرجع API: [waitForResponse](/docs/api/mock/waitForResponse).